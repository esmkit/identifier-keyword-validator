...
import { isIdentifierName } from "../src";
...
describe("isIdentifierName", function () {
  ...
  it.each(["hello", "$", "ゆゆ式", "$20", "hello20", "_", "if", "_\u200c", "_\u200d"])("returns true if provided string %p is an IdentifierName", function (word) {
    expect(isIdentifierName(word)).toBe(true);
  });
  it.each(["+hello", "0$", "-ゆゆ式", "#_", "_#", "\ud800\ud800"])("returns false if provided string %p is not an IdentifierName", function (word) {
